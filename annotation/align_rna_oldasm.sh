...
asm=/uru/Data/Nanopore/projects/moth/2020_analysis/ncbi_reference/hisat_index/GCF_000262585.1_Msex_1.0_genomic.fna
...
if [ "$1" == "single" ]; then
	...
	out=/uru/Data/Nanopore/projects/moth/2020_analysis/ncbi_reference/bam
	fastq=/uru/Data/Nanopore/projects/moth/2020_analysis/sra_rna_data/trim
	single=$(ls $in)
	for i in $single; do
		f=$(basename $i _1.fastq)
