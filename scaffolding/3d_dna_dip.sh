...
if [ $1 == 3d ] ; then
	/uru/Data/Nanopore/projects/moth/2020_analysis/scaffold/3d-dna/run-asm-pipeline.sh --mode diploid --editor-repeat-coverage 3 /uru/Data/Nanopore/projects/moth/2020_analysis/scaffold/juicer/references/moth_canu_nanopolish_racon1.fasta  /uru/Data/Nanopore/projects/moth/2020_analysis/scaffold/juicer/aligned_1/merged_nodups.txt
fi 
...
if [ $1 == final ] ; then
	...
	awk –f ./3d-dna/utils/generate-assembly-file-from-fasta.awk *.FINAL.fasta > FINAL.assembly
	3d-dna/run-asm-pipeline-post-review.sh -r FINAL.assembly moth_canu_nanopolish_racon1.FINAL.fasta /uru/Data/Nanopore/projects/moth/2020_analysis/scaffold/juicer/aligned/merged_nodups.txt
fi
...
# make the final hic file
/uru/Data/Nanopore/projects/moth/2020_analysis/scaffold/haploid_old/3d-dna/visualize/run-assembly-visualizer.sh /uru/Data/Nanopore/projects/moth/2020_analysis/scaffold/haploid_old/3d_dna_diploid/moth_canu_nanopolish_racon1.FINAL.200829.assembly /uru/Data/Nanopore/projects/moth/2020_analysis/scaffold/juicer/aligned/merged_nodups.txt
